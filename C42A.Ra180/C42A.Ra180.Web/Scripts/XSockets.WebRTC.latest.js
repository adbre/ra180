...
XSockets.WebRTC = function (ws, settings) {
    ...
    this.dispatch = function (eventName, message, obj) {
        ...
        var _eventName = "on" + eventName.capitalize();
    ...
    var rtcPeerConnection = function (configuration, peerId) {
        ...
        if (typeof (self.DataChannels) === "object" && configuration.sdpConstraints.optional.filter(function (a) { return a.hasOwnProperty("RtpDataChannels"); }).length == -1) {
